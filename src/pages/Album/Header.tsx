import useAlbum from '@/api/hooks/useAlbum'
import useUserAlbums, { useMutationLikeAAlbum } from '@/api/hooks/useUserAlbums'
...
import useAppleMusicAlbum from '@/api/hooks/useAppleMusicAlbum'
