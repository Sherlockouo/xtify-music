import { dailyCheckIn, fetchUserAccount } from '@/api/user'
...
import { removeAllCookies, setCookies } from '@/utils/cookie'
...
export default function useUser() {
  ...
  return useQuery(
    ...
    async () => {
      ...
      if(existsQueryData) return existsQueryData as FetchUserAccountResponse
      // if (!existsQueryData) {
        // window.ipcRenderer
